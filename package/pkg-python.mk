...
PKG_PYTHON_DISTUTILS_ENV_TARGET = \
	$(PKG_PYTHON_DISTUTILS_ENV) \
	PYTHONPATH="$(if $(BR2_PACKAGE_PYTHON3),$(PYTHON3_PATH),$(PYTHON_PATH))"

PKG_PYTHON_DISTUTILS_ENV_STAGING = \
	$(PKG_PYTHON_DISTUTILS_ENV) \
	PYTHONPATH="$(if $(BR2_PACKAGE_PYTHON3),$(PYTHON3_STAGING_PATH):$(PYTHON3_PATH),$(PYTHON_STAGING_PATH):$(PYTHON_PATH))"
...
PKG_PYTHON_SETUPTOOLS_ENV_TARGET = \
	$(PKG_PYTHON_SETUPTOOLS_ENV) \
	PYTHONPATH="$(if $(BR2_PACKAGE_PYTHON3),$(PYTHON3_PATH),$(PYTHON_PATH))"

PKG_PYTHON_SETUPTOOLS_ENV_STAGING = \
	$(PKG_PYTHON_SETUPTOOLS_ENV) \
	PYTHONPATH="$(if $(BR2_PACKAGE_PYTHON3),$(PYTHON3_STAGING_PATH):$(PYTHON3_PATH),$(PYTHON_STAGING_PATH):$(PYTHON_PATH))"
...
ifeq ($(4),target)
$(2)_BASE_ENV_TARGET           = $$(PKG_PYTHON_DISTUTILS_ENV_TARGET)
$(2)_BASE_ENV_STAGING          = $$(PKG_PYTHON_DISTUTILS_ENV_STAGING)
...
$(2)_BASE_ENV_HOST             = $$(HOST_PKG_PYTHON_DISTUTILS_ENV)
$(2)_BASE_BUILD_TGT            = build
$(2)_BASE_BUILD_OPTS           =
...
ifeq ($(4),target)
$(2)_BASE_ENV_TARGET           = $$(PKG_PYTHON_SETUPTOOLS_ENV_TARGET)
$(2)_BASE_ENV_STAGING          = $$(PKG_PYTHON_SETUPTOOLS_ENV_STAGING)
$(2)_BASE_BUILD_TGT            = build
$(2)_BASE_BUILD_OPTS           =
...
$(2)_BASE_ENV_HOST             = $$(HOST_PKG_PYTHON_SETUPTOOLS_ENV)
$(2)_BASE_BUILD_TGT            = build
$(2)_BASE_BUILD_OPTS           =
...
define $(2)_INSTALL_STAGING_CMDS
	(cd $$($$(PKG)_BUILDDIR)/; \
		$$($$(PKG)_BASE_ENV_STAGING) $$($$(PKG)_ENV) \
		$$($(2)_PYTHON_INTERPRETER) setup.py install \
